...
<head>
    ...
    <meta name="description"
        content="Khám phá vẻ đẹp nghệ thuật gốm sứ Thanh Hoa truyền thống với các họa tiết xanh trắng tinh xảo">
                    ...
                    <?php foreach ($products as $product): ?>
                        <div class="product-card fade-in">
                            <img src="<?php echo htmlspecialchars($product->image, ENT_QUOTES, 'UTF-8'); ?>"
                                ...
                                class="product-image">
                            <h2><a href="/MYSTORE/Product/show/<?php echo $product->id; ?>"
                                    class="product-title"><?php echo htmlspecialchars($product->name, ENT_QUOTES, 'UTF-8'); ?></a>
                            </h2>
                            ...
                            <div class="product-actions">
                                ...
                                <a href="/MYSTORE/Product/delete/<?php echo $product->id; ?>" class="btn-action btn-delete"
                                    onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này?');">
                                    <i class="fas fa-trash"></i> Xóa
                                </a>
                                <a href="/MYSTORE/Product/addToCart/<?php echo $product->id; ?>"
                                    class="btn-action btn-addToCart">Thêm vào giỏ hàng
                                </a>
                            </div>
                        </div>
                    <?php endforeach; ?>
        ...
        fetch('/MYSTORE/api/product')
            ...
            .then(data => {
                ...
                data.forEach(product => {
                    ...
                    <h2><a href="/MYSTORE/Product/show/${product.id}">${product.name}</a></h2> 
                    <p>${product.description}</p> 
                    <p>Giá: ${product.price} VND</p> 
                    <p>Danh mục: ${product.category_name}</p> 
                    <a href="/MYSTORE/Product/edit/${product.id}" class="btn btn warning">Sửa</a> 

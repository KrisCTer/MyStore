    ...
    <div class="row d-flex justify-content-center align-items-center h-100"> 
      <div class="col-12 col-md-8 col-lg-6 col-xl-5"> 
        <div class="card bg-dark text-white" style="border-radius: 1rem;"> 
          ...
          <form action="/MYSTORE/account/checklogin" method="post"> 
...
control-lg" /> 
              ...
              <p class="small mb-5 pb-lg-2"><a class="text-white-50" href="/MYSTORE/forgotpassword/index">Forgot 
password?</a></p> 
...
/MYSTORE/account/register " class="text-white-50 fw-bold">Sign Up</a> 
              </p> 
            </div> 
            </form> 
